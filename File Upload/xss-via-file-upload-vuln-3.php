...
array(5) {
    ...
    */
    // HINT: You can use the (Front File_Name)
    $blacklist = "/php|php2|php3|php4|php5|php6|php7|phps|phps|pht|phtm|phtml|pgif|shtml|htaccess|phar|inc|hphp|ctp|pdf|svg|html|gif/" ;
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_FILES['upload'])) {
        ...
        // U Can Bypass This Change Extension from php To PHP (Convert To UPPER Case )
            ...
            if (! preg_match($blacklist , $ext)){
                ...
                echo "<h4>Success uploaded File " . $file['name'] . " </h4>";
                //
